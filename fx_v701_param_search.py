...
# =========================================================
# FX PARAM SEARCH v701 FAST
# =========================================================
#
# 改善点:
# - Pandas iloc の大量アクセスをやめる
# - NumPy配列ベースで高速化
# - 各パラメータ実行時は最小限の情報だけ計算
# - 最良パラメータだけ詳細トレードを再生成
#
# 実行:
#   python .\fx_v701_param_search.py
#
# =========================================================
...
OUT_RESULTS = "fx_param_results_v701.csv"
OUT_BEST_TRADES = "fx_param_best_trades_v701.csv"
OUT_BEST_EQUITY = "fx_param_best_equity_v701.csv"
OUT_BEST_CANDIDATES = "fx_param_best_candidates_v701.csv"
...
# =========================================================
#
# まず速く試したい場合は、ここを少し減らしてください。
#
# 例:
# pullback_pct: [0.003, 0.005]
# tp_pct      : [0.004, 0.006]
# sl_pct      : [0.004, 0.006]
# hold_days   : [2, 3, 4]
#
...
def backtest_pair_min(data: PairData, params: Params) -> list[tuple[int, float, int]]:
    ...
    高速集計用。
    戻り値:
      (exit_date_value, net_return, side_int)
...
def run():
    print("========================================")
    print(" FX PARAM SEARCH v701 FAST")
    print("========================================")
    print(f"START             : {START}")
    print(f"END               : {END}")
    print(f"PAIRS             : {PAIRS}")
